...
CONCEPT_VERSION = "Concept v0.4.0"
...
@media(max-width:900px){.shell{display:block}.side{position:relative;height:auto;border-right:0;border-bottom:1px solid var(--line)}.file-list{max-height:300px;overflow:auto}.main{padding:0 14px 50px}.hero{margin:0 -14px 18px;padding:34px 20px}.hero svg{opacity:.2;width:100%}.toolbar{top:6px;align-items:flex-start;flex-direction:column}.actions{justify-content:flex-start}model-viewer{min-height:360px}}
</style>
</head>
<body>
<div class="shell">
